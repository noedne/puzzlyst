...
ModifierDyingWishApplyMechazorPlayerModifiers = require 'app/sdk/modifiers/modifierDyingWishApplyMechazorPlayerModifiers'
...
ModifierMyAttackWatchAreaDamage = require 'app/sdk/modifiers/modifierMyAttackWatchAreaDamage'
ModifierCostChangeIfEnemyGeneralDamagedThisTurn = require 'app/sdk/modifiers/modifierCostChangeIfEnemyGeneralDamagedThisTurn'
ModifierImmuneToAttacksIfFullHealth = require 'app/sdk/modifiers/modifierImmuneToAttacksIfFullHealth'
ModifierDealDamageWatchStealCards = require 'app/sdk/modifiers/modifierDealDamageWatchStealCards'
ModifierOpeningGambitApplyModifiers = require 'app/sdk/modifiers/modifierOpeningGambitApplyModifiers'
ModifierOpeningGambitPutRandomCardInHand = require 'app/sdk/modifiers/modifierOpeningGambitPutRandomCardInHand'
ModifierDyingWishApplyModifiersToGenerals = require 'app/sdk/modifiers/modifierDyingWishApplyModifiersToGenerals'
ModifierOpeningGambitBuffSelfByEnemiesNearby = require 'app/sdk/modifiers/modifierOpeningGambitBuffSelfByEnemiesNearby'
ModifierPreventAnyHeal = require 'app/sdk/modifiers/modifierPreventAnyHeal'
ModifierOpeningGambitBuffSelfByRemainingMana = require 'app/sdk/modifiers/modifierOpeningGambitBuffSelfByRemainingMana'
ModifierMyAttackOrCounterattackWatchHealOrDamageGeneral = require 'app/sdk/modifiers/modifierMyAttackOrCounterattackWatchHealOrDamageGeneral'
ModifierSongweaver = require 'app/sdk/modifiers/modifierSongweaver'
...
class CardFactory_CoreSet_Neutral
  ...
  @cardForIdentifier: (identifier,gameSession,version) ->
    ...
    if (identifier == Cards.Neutral.Mechaz0rHelm)
      ...
      card.rarityId = Rarity.Common
      card.setInherentModifiersContextObjects([
        ModifierDyingWishApplyMechazorPlayerModifiers.createContextObject()
      ])
    ...
    if (identifier == Cards.Neutral.PutridMindflayer)
      ...
      card.setInherentModifiersContextObjects([
        ...
        ModifierDyingWishDamageNearbyEnemies.createContextObject(1),
      ])
    ...
    if (identifier == Cards.Neutral.LightningBeetle)
      ...
      card.setInherentModifiersContextObjects([
        ModifierFlying.createContextObject(),
        ModifierMyAttackWatchAreaDamage.createContextObject(3),
      ])
    ...
    if (identifier == Cards.Neutral.PhaseHound)
      ...
      card.rarityId = Rarity.Rare
      card.setInherentModifiersContextObjects([
        ModifierCostChangeIfEnemyGeneralDamagedThisTurn.createContextObject(
          -1,
          i18next.t("modifiers.neutral_blaze_hound_modifier"),
        )
      ])
    ...
    if (identifier == Cards.Neutral.BlackSandBurrower)
      ...
      card.rarityId = Rarity.Rare
      card.setInherentModifiersContextObjects([
        ModifierImmuneToAttacksIfFullHealth.createContextObject()
      ])
    ...
    if (identifier == Cards.Neutral.SilvertongueCorsair)
      ...
      card.manaCost = 2
      card.rarityId = Rarity.Epic
      contextObject = ModifierDealDamageWatchStealCards.createContextObject()
      contextObject.enemyOnly = true
      contextObject.generalOnly = true
    ...
    if (identifier == Cards.Neutral.PrimusFist)
      ...
      card.manaCost = 2
      card.rarityId = Rarity.Common
      statContextObject = Modifier.createContextObjectWithAttributeBuffs(1,0)
      ...
      card.setInherentModifiersContextObjects([
        ModifierOpeningGambitApplyModifiers.createContextObjectForNearbyAllies(
          [statContextObject],
          false,
          'Give nearby allied minions +1/+0.',
        )
      ])
    ...
    if (identifier == Cards.Neutral.GolemMetallurgist)
      ...
      card.manaCost = 2
      card.rarityId = Rarity.Rare
      contextObject = PlayerModifierManaModifier.createCostChangeContextObject(-1, CardType.Unit, [Races.Golem])
      contextObject.activeInHand = contextObject.activeInDeck = contextObject.activeInSignatureCards = false
      contextObject.activeOnBoard = true
      card.setInherentModifiersContextObjects([
        ModifierCardControlledPlayerModifiers.createContextObjectOnBoardToTargetOwnPlayer([contextObject], "Your Golems cost 1 less.")
      ])
    ...
    if (identifier == Cards.Neutral.Sojourner)
      ...
      card.manaCost = 3
      card.setInherentModifiersContextObjects([
        ModifierOpeningGambitPutRandomCardInHand.createContextObject()
      ])
      card.rarityId = Rarity.Rare
    ...
    if (identifier == Cards.Neutral.Crossbones)
      ...
      card.rarityId = Rarity.Rare
      card.setInherentModifiersContextObjects([
        ModifierDyingWishApplyModifiersToGenerals.createContextObject(
    ...
    if (identifier == Cards.Neutral.SwornDefender)
      ...
      card.setInherentModifiersContextObjects([
        ModifierProvoke.createContextObject(),
        ModifierOpeningGambitBuffSelfByEnemiesNearby.createContextObject(
          0,
          1,
          i18next.t("modifiers.neutral_sworn_defender_modifier"),
        ),
      ])
    ...
    if (identifier == Cards.Neutral.Mindwarper)
      ...
      card.manaCost = 3
      card.rarityId = Rarity.Legendary
      contextObject = PlayerModifierReplaceFromOpponentDeck.createContextObject()
      contextObject.activeInHand = contextObject.activeInDeck = contextObject.activeInSignatureCards = false
      contextObject.activeOnBoard = true
      card.setInherentModifiersContextObjects([
        ModifierCardControlledPlayerModifiers.createContextObjectOnBoardToTargetBothPlayers(
          [contextObject],
          'Players replace from their opponent\'s deck.',
        )
      ])
    ...
    if (identifier == Cards.Neutral.LuxIgnis)
      ...
      card.setInherentModifiersContextObjects([
        ModifierRanged.createContextObject(),
        ModifierEndTurnWatchHealNearby.createContextObject(2, true),
      ])
    ...
    if (identifier == Cards.Neutral.Spelljammer)
      ...
      contextObject.activeOnBoard = true
      card.setInherentModifiersContextObjects([
        ModifierCardControlledPlayerModifiers.createContextObjectOnBoardToTargetBothPlayers([contextObject], "Players draw 1 fewer card at the end of their turn.")
      ])
    ...
    if (identifier == Cards.Neutral.Dilotas)
      ...
      card.manaCost = 4
      card.rarityId = Rarity.Epic
      card.setInherentModifiersContextObjects([ModifierDyingWishSpawnEntityNearbyGeneral.createContextObject({id: Cards.Neutral.DilotasTombstone}, "a 0/10 Tombstone minion with Provoke")])
    ...
    if (identifier == Cards.Neutral.Maw)
      ...
      card.setFollowups([
        {
          id: Cards.Spell.FollowupDamageAndBuffSelf
    ...
    if (identifier == Cards.Neutral.DeathBlighter)
      ...
      card.rarityId = Rarity.Rare
      card.setInherentModifiersContextObjects([
        ModifierPreventAnyHeal.createContextObject()
      ])
    ...
    if (identifier == Cards.Neutral.VoidHunter)
      ...
      card.setInherentModifiersContextObjects([ModifierDyingWishDrawCard.createContextObject(2)])
      card.atk = 4
      card.maxHP = 2
      card.manaCost = 3
      card.rarityId = Rarity.Common
    ...
    if (identifier == Cards.Neutral.FirstSwordofAkrane)
      ...
      card.setInherentModifiersContextObjects([Modifier.createContextObjectWithAuraForAllAlliesAndGeneral([customContextObject], null, null, null, "Your other allies have +1 Attack")])
      card.atk = 7
      card.maxHP = 7
      card.manaCost = 6
      card.rarityId = Rarity.Rare
    ...
    if (identifier == Cards.Neutral.Moebius)
      ...
      card.setInherentModifiersContextObjects([
        ModifierAirdrop.createContextObject(),
        ModifierOpeningGambitBuffSelfByRemainingMana.createContextObject(1, 1),
      ])
      card.rarityId = Rarity.Epic
    ...
    if (identifier == Cards.Neutral.Purgatos)
      ...
      card.manaCost = 4
      card.setInherentModifiersContextObjects([
        ModifierMyAttackOrCounterattackWatchHealOrDamageGeneral.createContextObject(2, 2)
      ])
      card.rarityId = Rarity.Legendary
    ...
    if (identifier == Cards.Neutral.Songweaver)
      ...
      card.rarityId = Rarity.Rare
      card.setInherentModifiersContextObjects([
        ModifierSongweaver.createContextObject(3)
      ])
    ...
    if (identifier == Cards.Neutral.EmeraldRejuvenator)
      ...
      card.rarityId = Rarity.Common
      card.setInherentModifiersContextObjects([
        ModifierOpeningGambitHealMyGeneral.createContextObject(4)
      ])
